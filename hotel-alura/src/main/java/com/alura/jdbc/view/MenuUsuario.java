...
public class MenuUsuario extends JFrame {
	 ...
	 * Create the frame.
	 */
	public MenuUsuario(Huespedes usuario) {
		
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuUsuario.class.getResource("/com/alura/jdbc/imagenes/aH-40px.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(MenuUsuario.class.getResource("/com/alura/jdbc/imagenes/aH-150px.png")));
		...
		labelRegistro.setIcon(new ImageIcon(MenuUsuario.class.getResource("/com/alura/jdbc/imagenes/reservado.png")));
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(MenuUsuario.class.getResource("/com/alura/jdbc/imagenes/pessoas.png")));
	    ...
	    lblNewLabel_1.setBounds(90, 11, 550, 42);
	    panelFecha.add(lblNewLabel_1);
	    lblNewLabel_1.setForeground(Color.WHITE);
	    lblNewLabel_1.setFont(new Font("Roboto", Font.BOLD, 26));
	    ...
	    lblNewLabel_3.setBounds(312, 444, 355, 27);
	    contentPane.add(lblNewLabel_3);
	    
	    JLabel lblNewLabel_3_1 = new JLabel("- Edición de Reservas y Huéspedes existentes.");
	    lblNewLabel_3_1.setFont(new Font("Roboto", Font.BOLD, 17));
	    lblNewLabel_3_1.setBounds(312, 482, 380, 27);
	    contentPane.add(lblNewLabel_3_1);
	    
	    JLabel lblNewLabel_3_2 = new JLabel("- Eliminar todo tipo de registros.");
	    lblNewLabel_3_2.setFont(new Font("Roboto", Font.BOLD, 17));
	    lblNewLabel_3_2.setBounds(312, 520, 355, 27);
