...
public class ReservasView extends JFrame {
	...
	private static final int VALORNOCHE = 80000;
	 ...
	 * Create the frame.
	 */
	public ReservasView(Huespedes huesped) {
		super("Reserva");

		this.reservaController = new ReservasController();

		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(ReservasView.class.getResource("/com/alura/jdbc/imagenes/aH-40px.png")));
		...
		lblTitulo.setBounds(101, 60, 300, 42);
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(ReservasView.class.getResource("/com/alura/jdbc/imagenes/Ha-100px.png")));
		...
		imagenFondo
				.setIcon(new ImageIcon(ReservasView.class.getResource("/com/alura/jdbc/imagenes/reservas-img-3.png")));
		...
		btnAtras.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				MenuUsuario usuarios = new MenuUsuario(huesped);
				usuarios.setVisible(true);
				dispose();
			}
		...
		txtFechaEntrada.getCalendarButton()
				.setIcon(new ImageIcon(ReservasView.class.getResource("/com/alura/jdbc/imagenes/icon-reservas.png")));
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if (ReservasView.txtFechaEntrada.getDate() != null) {
					...
					String valorReserva = String.valueOf(calcularDias() * VALORNOCHE);
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (validarFechas(fechaIngreso, fechaSalida)) {
					...
					Long valorReserva = calcularDias() * VALORNOCHE;

					String codigoReserva = reservaController.crearReserva();
					var reservas = new Reservas(fechaIngreso, fechaSalida, formaPago, codigoReserva, valorReserva);
					RegistroHuesped registro = new RegistroHuesped(huesped, reservas);
	...
	private boolean validarFechas(Date fechaIngreso, Date fechaSalida) {
		...
		if(fechaIngreso != null && fechaSalida != null) {
			...
			if (fechaSalida.compareTo(fechaIngreso) > 0) {
				...
				JOptionPane.showMessageDialog(null, "Selecciona una fecha posterior a la fecha de tu ingreso.");
				return false;
			}
	...
	private Long calcularDias() {
		...
		Long dias = unidad.convert(diferencia, TimeUnit.MILLISECONDS);
